...
<div class="row featured">
    <div class="twelve columns">
        ...
        <ul class="button-group radius orbit-buttons">
          ...
          <li data-orbit-index="1"><a href="#" class="button radius">Lead a Drive</a></li>
          <li data-orbit-index="2"><a href="#" class="button radius">Volunteer</a></li>
          <li data-orbit-index="3"><a href="#" class="button radius">Donate Today</a></li>
        </ul>
    </div>
</div>
